...
with PSQL_wrapper(args) as psql:
    ...
    for operator in range(len(operators)):
        ...
        """
        if operators[operator] == "Operator: 1091":
            print(res.result)
            print(alarms)
        """
    ...
    for software in failures:
        frequency[software] = failures[software]/soft_life[software]
        print(software, ": ", frequency[software]*100*30)