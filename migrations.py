    ...
    with PSQL_wrapper(args) as psql:
        ...
        for operator in range(len(operators)):
            ...
            #for migration in migrations:
                #print(migration, migrations[migration])
            ...
            #for migration in migration_dates:
                #print(migration, migration_dates[migration])
            ...
            #for q in range(len(assigned_alarms)):
                ...
                #for migration in assigned_alarms[q]:
                    #print(migration, assigned_alarms[q][migration])
